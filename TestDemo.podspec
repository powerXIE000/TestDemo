...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/powerXIE000/TestDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zheyuxie' => 'zheyuxie@tencent.com' }
  s.source           = { :git => 'https://github.com/powerXIE000/TestDemo.git', :tag => s.version.to_s }
